...
├── .windsurf/memories/    ← Windsurf persistent context & commands
...
|---------|-------------|-------|
| `/review` | Review code using relevant tech skill & guidelines | `/review file="src/App.java"` |
...
| `/spec-validate` | Validate SDD artifacts for consistency & efficiency | `/spec-validate` |
