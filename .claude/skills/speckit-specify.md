...
4. Extract goals, non-goals, users, and constraints from the description.
5. Define acceptance criteria as bullet points (testable, concrete).
...
9. Keep it brief; link to relevant memories if needed.
