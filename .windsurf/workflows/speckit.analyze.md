...
9. Output a concise report (max 50 findings; summarize overflow) with prioritized fixes and suggested follow-ups (`/speckit.clarify`, `/speckit.plan`, `/speckit.tasks`).
