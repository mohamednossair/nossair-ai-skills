---
description: Generate an actionable, dependency-ordered tasks.md based on the plan/spec
---
...
7. Include acceptance criteria and definition of done for each task.
